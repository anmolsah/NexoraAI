      ...
      >
        ...
        <div className="my-6 flex items-center gap-2">
          <label className="relative cursor-pointer">
            ...
            />
            <div className="w-9 h-5 bg-slate-300 rounded-full peer-checked:bg-green-500 trasnsition"></div>
            <span className="absolute left-1 top-1 bg-white w-3 h-3 rounded-full peer-checked:translate-x-4"></span>
          </label>
